<template>
  <div class="dialog">
    <a-modal v-model:visible="visible" :title="editMode ? '编辑权限' : '新建权限'" @cancel="handleCancel" :on-before-ok="handleSubmit">
      <a-form ref="formRef" :model="form">
        ...
        <a-form-item
          ...
          :validate-trigger="['change','input']"
        >
          <a-input v-model="form.target" :max-length="20" />
        </a-form-item>
        <a-form-item
          field="action"
          label="权限动作"
...
import { createPermission, updatePermission, type Permission } from '@/api/permission'
