...
export async function listUserRoles(
  req: ListUserRoleReq,
): Promise<ListUserRoleResp> {
  return await request.get(`/api/v1/users/${req.userId}/roles`, req)
}
...
export async function addUserRole(req: AddUserRoleReq) {
  return await request.post(`/api/v1/users/${req.userId}/roles/add`, req)
}
...
export async function deleteUserRole(req: DeleteUserRoleReq) {
  return await request.post(`/api/v1/users/${req.userId}/roles/delete`, req)
}
...
export async function listRole(
  req: ListRolePageReq,
): Promise<ListRolePageResp> {
  return await request.get('/api/v1/roles', req)
}
...
export async function createRole(req: createRoleReq) {
  return await request.post('/api/v1/roles', req)
}
...
export async function updateRole(roleId: numberic, req: updateRoleReq) {
  return await request.put(`/api/v1/roles/${roleId}`, req)
}

export async function deleteRole(roleId: numberic) {
  return await request.delete(`/api/v1/roles/${roleId}`)
}
...
export async function getRole(roleId: numberic): Promise<Role> {
  return await request.get(`/api/v1/roles/${roleId}`)
}
...
export async function listRolePermission(
  roleId: numberic,
  req: RolePermissionReq,
): Promise<RolePermissionResp> {
  return await request.get(`/api/v1/roles/${roleId}/permissions`, req)
}
...
export async function addRolePermission(
  roleId: numberic,
  req: AddRolePermissionReq,
) {
  return await request.post(`/api/v1/roles/${roleId}/permissions/add`, req)
}
...
export async function deleteRolePermission(
  roleId: numberic,
  req: DeleteRolePermissionReq,
) {
  return await request.post(`/api/v1/roles/${roleId}/permissions/delete`, req)
}
...
export async function listRoleMenu(
  roleId: numberic,
): Promise<ListRoleMenuResponse> {
  return await request.get(`/api/v1/roles/${roleId}/menus`)
}
...
export async function setRoleMenu(roleId: numberic, req: SetRoleMenuReq) {
  return await request.post(`/api/v1/roles/${roleId}/menus/set`, req)
}
